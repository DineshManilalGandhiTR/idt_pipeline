...
do
	...
	PATH_FLOW="/home/.../flowSeq/" # path to flow files
	...
	FILE_FLOW_SUFFIX="/flow*.png"
	FILE_IMAGE_SUFFIX="/img*.png"
	...
	FILE_FLOW_FULL_PATH=${PATH_FLOW}${FILE_NAME_VIDEO}${FILE_FLOW_SUFFIX}
	FILE_IMAGE_FULL_PATH=${PATH_IMAGE}${FILE_NAME_VIDEO}${FILE_IMAGE_SUFFIX}

	./DenseTrackStab -f "$FILE_FLOW_FULL_PATH" -p "$FILE_IMAGE_FULL_PATH" -o $FILE_NAME_IDT -r $FILE_NAME_TRA
